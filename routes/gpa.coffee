...
exports.gpaPostResponse = (req, res) ->
  res.send headerStr + formString + '<p>Your GPA is ' + gradeIt(numbersToArray(req.body.grade1,req.body.grade2,req.body.grade3, req.body.grade4),creditsToArr(req.body.credit1, req.body.credit2, req.body.credit3, req.body.credit4)) + '</p>' + footerStr
